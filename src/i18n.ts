...
export const COPY: Record<Lang, Copy> = {
  en: {
    ...
    heroDesc: 'AURA is a 1.2L stainless steel bottle with a built-in magnetic ring that snaps your phone to the top. Keeps cold for 12 hours, hot for 12 hours — engineered for the way you actually live.',
    heroCta: 'Order Now',
    heroScroll: 'Scroll',
  ...
  ar: {
    ...
    heroDesc: 'AURA مطرة ستانلس ستيل سعة 1.2 لتر مع حلقة مغناطيسية مدمجة تثبت هاتفك على الأعلى. تحافظ على البرودة 12 ساعة والحرارة 12 ساعة — مصممة لطريقة عيشك الحقيقية.',
    heroCta: 'اطلب الآن',
    heroScroll: 'مرّر',
